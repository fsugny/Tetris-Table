...
//        if (IOE16_MonitorIOPin (SD_DETECT_PIN) != 0) {
...
SD_Error SD_EnableWideBusOperation (uint32_t WideMode)
{
    ...
    {
        logf( "MMC Card doesn't support wide bus\r\n");
             ...
             (SDIO_HIGH_CAPACITY_SD_CARD == CardType))
    {
        ...
        else if (SDIO_BusWide_4b == WideMode)
        {
            ...
            {
                logf("SDEnWideBus(ENABLE) Failed\r\n");
            }
        }
        else
        {
            ...
            {
                logf("SDEnWideBus(DISABLE) Failed\r\n");
            }
        }
    }
...
static SD_Error SDEnWideBus (FunctionalState NewState)
{
    ...
    if ( NewState == ENABLE )
    {
        ...
        if ( ( scr[1] & SD_WIDE_BUS_SUPPORT ) != SD_ALLZERO )
        {
            ...
            if (errorstatus != SD_OK)
            {
                logf("Error Setting SD Bus Width 1\r\n");
                return (errorstatus);
            }
            return (errorstatus);
        }
        ...
        {
            logf("SD Request Not Applicable 1\r\n");
            errorstatus = SD_REQUEST_NOT_APPLICABLE;
            return (errorstatus);
        }
    ...
    else
    {
        ...
        if ((scr[1] & SD_SINGLE_BUS_SUPPORT )!= SD_ALLZERO)
        {
            ...
            if (errorstatus != SD_OK)
            {
                logf("Error Setting SD Bus Width 2\r\n");
                return (errorstatus);
            }
        ...
        {
            logf("SD Request Not Applicable 2\r\n");
            errorstatus = SD_REQUEST_NOT_APPLICABLE;
            return (errorstatus);
        }
    }
