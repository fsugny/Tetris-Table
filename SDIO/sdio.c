...
uint32_t uwSDCardOperation = SD_OPERATION_BLOCK;
...
void SD_EraseTest (void)
{
        ...
        if (Status == SD_OK) {
                ...
                if (Status == SD_OK) {
                        printf ("SD_ReadMultiBlocks OK\r\n");
                }
                else {
                        printf ("SD_ReadMultiBlocks failed\r\n");
                }
                ...
                if (Status == SD_OK) {
                        printf ("SD_WaitReadOperation OK\r\n");
                }
                else {
                        printf ("SD_WaitReadOperation failed\r\n");
                }
...
#define USE_PIN_SET 1
        ...
        gpioInitStruct.GPIO_Speed = GPIO_Speed_50MHz;//GPIO_High_Speed;
